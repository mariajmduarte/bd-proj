...
create table regiao (
  num_regiao varchar(1) not null, --5 regioes
...
create table concelho (
  num_concelho varchar(3) not null,--308 municipios
...
create table instituicao (
  nome varchar(60) not null, --Hospital Santo António dos Capuchos
...
create table consulta (
  ...
  constraint fk_consulta_instituicao foreign key(nome_instituicao) references instituicao(nome) on delete cascade on update cascade
  );
...
create table analise (
  num_analise varchar(7) not null unique,
...
create table venda_farmacia (
  num_venda varchar(23) not null unique,
  data_registo date not null,
  substancia varchar(50) not null,
  quant varchar(10) not null,
